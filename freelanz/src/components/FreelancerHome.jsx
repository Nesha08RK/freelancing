          ...
          <div className="container">
            <div className="row justify-content-center text-center">
              <div className="col-xl-6 col-lg-8">
                {user && (
                  <div className="mb-4">
                    <h3>Hi {user.fullName || "Freelancer"}!</h3>
                  </div>
                )}
                <h2 className="animated-text">Find Talent. Find Work. Find Success!<span>.</span></h2>
                ...
                <div className="mt-4">
                  ...
                  {user && user.role === 'freelancer' && (
                    <Link to="/available-jobs" className="btn btn-primary mx-2">
                      Find Jobs
                    </Link>
                  )}
                </div>
